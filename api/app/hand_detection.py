...
def extract_hand_type_index(multi_handedness: Sequence,hand_type: Literal["left", "right"]) -> int:
    """
...
def extract_left_right_hand_coords(multi_hand_landmarks: Optional[Sequence],multi_handedness: Sequence,) -> dict:
    """
    ...
    """
    hand_coords = {"left": None,"right": None}
...
def run_hand_tracking_server(frame):
    """
